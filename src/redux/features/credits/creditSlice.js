...
export const createCredid = createAsyncThunk(
	'credit/createCredid',
	async ({ client, vid, value11, value21, value12, value22, value13, value23, value14, value24, value15, value25, DateTime, Mesiac }, { rejectWithValue }) => {
		try {
			const { data } = await axios.post('/credit/create', { client, vid, value11, value21, value12, value22, value13, value23, value14, value24, value15, value25, DateTime, Mesiac })
			return data.credit
		} catch (error) {
