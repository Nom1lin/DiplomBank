...
const MyCart = ({ cart }) => {
	...
	const handleUpDate = (cartId) => {
		...
		} else if (cartName.length === 19) { // Проверяем, что длина строки равна 20 символам
			setBal(bal - balans);
			toast('Перевод совершен');
		} else {
			// Логика обновления состояния или другие действия, если cartName не пустая и содержит ровно 20 символов
			toast('Проверьте номер карты, возможно вы не полностью ввели');
		}
	}
