				...
				<div className="2xl:flex justify-between sm:block">
					...
					<ul className=''>
						<div className='mb-[29px] 2xl:mt-[-13px] sm:mt-[13px]'> {/* Инпут 1*/}  {/*--- Сумма займа */}
							...
							<div className="2xl:w-[500px] 2xl:h-[99px] sm:w-[100%] sm:h-[85px] bg-Jerry shadow-xxB rounded-[40px] pl-[30px] text-[24px] pt-[]"><li className='text-[20px] 2xl:mb-[8px] '>{props.input21}</li>{value21} месяц</div>
