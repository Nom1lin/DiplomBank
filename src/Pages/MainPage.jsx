...
export const MainPage = () => {
	return (
		<>
			<Face main='Добро пожаловать в [название банка], где мы стремимся быть вашим надежным финансовым партнером на всю жизнь. Мы предлагаем широкий спектр банковских услуг, разработанных для удовлетворения всех ваших финансовых потребностей.'
			...
			<div className='mt-[160px] text-Melody'>
				...
				<div className='flex justify-between  mt-[20px]'>
					...
					<Ramki text='Программы лояльности и бонусы' img={Image5} w='w-[690px]' h='h-[322px]' wi='w-[250px]' hi='h-[250px]' px='px-[225px]' pt='pt-[10px]' />
				</div>
			</div>
